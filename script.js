onload = function () {
    ...
    const tools = {
        ...
        //flip horizontally
        "flipHor" : function(){
            let cols = editor.width; // Width = number of columns
            let rows = editor.height; // Height = number of rows
        ...
        "resize" : function(){
            ...
            let inp = prompt('Current Width : '+cols + '\n' + 'Current Height : '+rows + '\n' + 'Give the new width and height with a space in between').split(' ');
            if(inp.length!==2){
                alert('Incorrect dimensions added');
                return;
            }
